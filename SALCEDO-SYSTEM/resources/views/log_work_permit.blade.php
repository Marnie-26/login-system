        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full pb-16 overflow-y-auto">
                <div class="container grid px-6 mx-auto">
                    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"> Add new work permit record</h2>
                            ...
                            <form action="{{ route('permit.store') }}" method="POST">
                                        ...
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                <input
                                                    ...
                                                    type="text"
                                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                                    placeholder="Enter name of resident or owner"
                                                    required
                                                />
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                <input
                                                    ...
                                                    type="text"
                                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                                    placeholder="Enter name contractor"
                                                    required
                                                />
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                ...
                                <div class="absolute bottom-0 right-0 mb-4 mr-4 mt-4">
                                    <button class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                                        <i class="fa-solid fa-plus"></i> Log Work Permit
                                    </button>
                                </div>
                            </form>
                        </div>
